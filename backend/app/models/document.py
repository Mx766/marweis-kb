import datetime
from sqlalchemy import String, Integer, BigInteger, Boolean, Date, Text, JSON, DateTime
...
class Document(Model, Base, TimestampMixin):
    ...
    markdown_status: Mapped[str] = mapped_column(
        String(20), default="pending", server_default="pending", nullable=False
    )
    markdown_updated_at: Mapped[datetime.datetime | None] = mapped_column(
