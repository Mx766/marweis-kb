...
CATEGORIES_DATA = [
    ...
    # ── 器械注册部 — 按注册工作流组织的 7 模块结构 ──
    {"name": "1. 参考文件", "icon": "folder", "visible": ["器械注册部"],
     "children": [
         {"name": "通用法规（国内）", "icon": "law", "visible": ["器械注册部"]},
         {"name": "通用法规（国外）", "icon": "law", "visible": ["器械注册部"]},
         {"name": "指导原则", "icon": "guide", "visible": ["器械注册部"]},
         {"name": "审评论坛", "icon": "chat", "visible": ["器械注册部"]},
     ]},
    {"name": "2. 分类目录", "icon": "tag", "visible": ["器械注册部"],
     "children": []},
    {"name": "3. 校验技术要求", "icon": "standard", "visible": ["器械注册部"],
     "children": []},
    {"name": "4. 临床评价资料", "icon": "chart", "visible": ["器械注册部"],
     "children": [
         {"name": "临床文献", "icon": "book", "visible": ["器械注册部"]},
         {"name": "国家局网站", "icon": "link", "visible": ["器械注册部"]},
         {"name": "说明书", "icon": "doc", "visible": ["器械注册部"]},
     ]},
    {"name": "5. 发补", "icon": "clock", "visible": ["器械注册部"],
     "children": [
         {"name": "例卷", "icon": "archive", "visible": ["器械注册部"]},
         {"name": "发补意见", "icon": "chat", "visible": ["器械注册部"]},
     ]},
    {"name": "6. 注册证书", "icon": "shield", "visible": ["器械注册部"],
     "children": [
         {"name": "注册证书", "icon": "certificate", "visible": ["器械注册部"]},
         {"name": "注册资料", "icon": "archive", "visible": ["器械注册部"]},
     ]},
    {"name": "7. 通讯录", "icon": "phone", "visible": ["器械注册部"],
     "children": [
         {"name": "中央药监局", "icon": "link", "visible": ["器械注册部"]},
         {"name": "地方药监局", "icon": "link", "visible": ["器械注册部"]},
     ]},
...
SAMPLE_DOCUMENTS = [
    ...
    # 器械注册部 - 参考文件
    {"title": "医疗器械监督管理条例（2025修订）", "category": "通用法规（国内）",
     "tags": ["法规", "监督管理", "2025"], "source": "国务院", "file_type": "link",
     "summary": "《医疗器械监督管理条例》于2025年修订施行，明确了医疗器械全生命周期监管要求。",
     "source_url": "https://www.nmpa.gov.cn/xxgk/fgwj/flxzhg/20241101151126150.html"},
    {"title": "医疗器械注册管理办法（2025版）", "category": "通用法规（国内）",
     "tags": ["注册管理", "2025"], "source": "NMPA", "file_type": "link",
     "summary": "规范医疗器械注册管理，明确注册申请、技术审评、行政审批等流程和要求。",
     "source_url": "https://www.nmpa.gov.cn/ylqx/ylqxfgwj/ylqxbmgzh/20250101181001561.html"},
    {"title": "FDA 21 CFR Part 820 质量体系法规", "category": "通用法规（国外）",
     "tags": ["FDA", "QSR", "质量体系"], "source": "FDA", "file_type": "link",
     "summary": "FDA 21 CFR Part 820 质量体系法规（QSR），规定了医疗器械CGMP要求。",
     "source_url": "https://www.ecfr.gov/current/title-21/chapter-I/subchapter-H/part-820"},
    {"title": "EU MDR 2017/745 医疗器械法规", "category": "通用法规（国外）",
     "tags": ["EU MDR", "CE认证", "欧洲"], "source": "欧盟委员会", "file_type": "link",
     "summary": "EU Medical Device Regulation (MDR) 2017/745 是欧盟医疗器械监管的核心法规。",
     "source_url": "https://eur-lex.europa.eu/eli/reg/2017/745/oj"},
    {"title": "医疗器械临床评价技术指导原则（2025版）", "category": "指导原则",
     "tags": ["临床评价", "技术指导", "2025"], "source": "CMDE", "file_type": "link",
     "summary": "更新版临床评价技术指导原则，明确了临床评价报告的撰写要求和等同性论证路径。",
     "source_url": "https://www.cmde.org.cn/CL0112/25300.html"},
    {"title": "器审中心审评论坛 — 注册申报常见问题", "category": "审评论坛",
     "tags": ["审评", "常见问题"], "source": "CMDE", "file_type": "link",
     "summary": "器审中心整理的医疗器械注册申报审评中常见问题及解答。",
     "source_url": "https://www.cmde.org.cn/sqrzc/zxfw/lcjtcn/index.html"},

    # 器械注册部 - 分类目录
    {"title": "医疗器械分类目录（2024修订版）", "category": "2. 分类目录",
     "tags": ["分类目录", "2024"], "source": "NMPA", "file_type": "link",
     "summary": "明确医疗器械产品分类框架和具体类别，新增AI医疗软件等分类条目。",
     "source_url": "https://www.nmpa.gov.cn/ylqx/ylqxggtg/ylqxzhgg/20240411091014152.html"},

    # 器械注册部 - 校验技术要求
    {"title": "有源医疗器械产品技术要求编写指南", "category": "3. 校验技术要求",
     "tags": ["技术要求", "有源器械"], "source": "CMDE", "file_type": "link",
     "summary": "有源医疗器械产品技术要求的编写规范和检测要点。",
     "source_url": "https://www.cmde.org.cn/CL0112/24000.html"},

    # 器械注册部 - 临床评价资料
    {"title": "角膜交联仪临床评价报告", "category": "临床文献",
     "tags": ["案例", "眼科器械", "CER"], "source": "迈瑞生项目组", "file_type": "link",
     "summary": "Iromed角膜交联仪免临床评价通过NMPA审批。",
     "source_url": "https://www.maris-reg.com/nd.jsp?id=831"},
    {"title": "器审中心临床评价推荐路径", "category": "国家局网站",
     "tags": ["临床评价", "推荐路径"], "source": "CMDE", "file_type": "link",
     "summary": "国家药监局器审中心关于发布医疗器械分类目录相关产品临床评价推荐路径。",
     "source_url": "https://www.cmde.org.cn/sqrzc/zxfw/lcjtcn/lcjtlcpj/lcjttpzdb/index.html"},

    # 器械注册部 - 发补
    {"title": "三类医疗器械发补意见案例集", "category": "发补意见",
     "tags": ["发补", "案例", "三类"], "source": "迈瑞生项目组", "file_type": "link",
     "summary": "三类医疗器械注册申报发补常见意见及回复策略。",
     "source_url": "https://www.maris-reg.com/nd.jsp?id=870"},

    # 器械注册部 - 注册证书
    {"title": "创新医疗器械特别审查程序", "category": "注册资料",
     "tags": ["创新", "绿色通道"], "source": "NMPA", "file_type": "link",
     "summary": "创新医疗器械特别审查程序申请指南，适用于具有核心技术发明专利的产品。",
     "source_url": "https://www.nmpa.gov.cn/ylqx/ylqxggtg/ylqxzhgg/20250120171014152.html"},

    # 器械注册部 - 通讯录
    {"title": "国家药监局医疗器械技术审评中心", "category": "中央药监局",
     "tags": ["通讯录", "器审中心"], "source": "CMDE", "file_type": "link",
     "summary": "国家药监局医疗器械技术审评中心联系方式。",
     "source_url": "https://www.cmde.org.cn/sqrzc/zxfw/lcjtcn/index.html"},
    {"title": "北京市药品监督管理局", "category": "地方药监局",
     "tags": ["通讯录", "北京"], "source": "北京药监局", "file_type": "link",
     "summary": "北京市药品监督管理局联系方式。",
     "source_url": "https://yjj.beijing.gov.cn/"},
