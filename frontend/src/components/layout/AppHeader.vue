  ...
  <header class="app-header">
    <div class="header-inner">
      ...
      <router-link to="/" class="logo-section">
        ...
        <div class="logo-text">
          <span class="logo-title">企业知识库</span>
          <span class="logo-subtitle">Enterprise KB</span>
        </div>
      </router-link>
      ...
      <nav class="header-nav">
        ...
        <router-link to="/files" class="nav-link" :class="{ active: isFiles }">团队公盘</router-link>
        <router-link to="/oa" class="nav-link" :class="{ active: isOa }">OA</router-link>
        <router-link
          v-if="auth.isAdmin"
          to="/admin"
          class="nav-link"
      ...
      <div class="header-right">
        ...
        <div class="header-search" :class="{ focused: searchFocused }">
          ...
          />
          <button class="search-btn" @click="doSearch" :disabled="!searchText.trim()">
...
.search-btn:disabled:hover { background: var(--color-primary); }
