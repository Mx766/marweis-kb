...
const DEPT_CONFIG: Record<string, { icon: string; label: string; color: string }> = {
  '器械注册部':   { icon: 'M', label: '器械注册部', color: '#1e50ae' },
  '临床评价部':   { icon: 'C', label: '临床评价部', color: '#2e86c1' },
  '临床试验部':   { icon: 'T', label: '临床试验部', color: '#27ae60' },
  '生产体系部':   { icon: 'Q', label: '生产体系部', color: '#8e44ad' },
  '化妆品·医美部（迈美丝）': { icon: 'M', label: '化妆品·医美部', color: '#e74c3c' },
  '化妆品·医美部': { icon: 'M', label: '化妆品·医美部', color: '#e74c3c' },
  '特医食品部':   { icon: 'F', label: '特医食品部', color: '#fb8c00' },
  '管理层':       { icon: 'A', label: '管理层', color: '#333333' },
}
