<template>
  <div class="admin-page">
    <div class="page-toolbar">
      <el-button v-if="isSuperAdmin" type="primary" @click="handleAdd">添加一级分类</el-button>
      <el-button @click="loadData" :loading="loading">刷新</el-button>
    </div>

    <!-- Department tabs -->
    <el-tabs v-if="isSuperAdmin" v-model="activeDept" @tab-change="onDeptChange">
    ...
    <el-table :data="filteredCategories" stripe row-key="id" v-loading="loading">
      ...
      <el-table-column v-if="isSuperAdmin" label="操作" width="280" fixed="right">
        <template #default="{ row }">
